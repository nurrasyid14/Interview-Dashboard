...
def render():
    ...
    st.info("Please fill in your information to continue")
    ...
    with st.form("identity_form"):
        ...
        if submitted:
            if not full_name:
                ...
                st.error("Birthdate is required")
            elif not validate_age(birthdate):
                st.error("Invalid birthdate format or you are underage")
            elif not address:
